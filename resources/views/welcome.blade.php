...
@section('content')
                  ...
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-lg-7 text-center">
                           <p class="fs-4 animated zoomIn text-white">Welcome to <strong class="text-dark">TEA
                                 House</strong></p>
                           <h1 class="display-1 text-dark animated zoomIn mb-4">Organic & Quality Tea Production</h1>
                           <a href="" class="btn btn-light rounded-pill animated zoomIn px-5 py-3">Explore More</a>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- Products Start -->
   <div class="container-fluid product my-5 py-5">
   ...
   <div class="container-fluid video my-5">
      <div class="container">
         <div class="row g-0">
            <div class="col-lg-6 wow fadeIn py-5" data-wow-delay="0.1s">
               <div class="py-5">
                  <h1 class="display-6 mb-4">Tea is a drink of <span class="text-white">health</span> and <span
                        class="text-white">beauty</span></h1>
                  <h5 class="fw-normal lh-base fst-italic mb-5 text-white">Tempor erat elitr rebum at clita. Diam dolor
                     diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit</h5>
                  <div class="row g-4 mb-5">
                     <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                           <div class="btn-lg-square text-primary rounded-circle me-3 flex-shrink-0 bg-white">
                  ...
                  <a class="btn btn-light rounded-pill px-5 py-3" href="">Explore More</a>
               </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
   ...
   <!-- Testimonial Start -->
   <div class="container-fluid testimonial my-5 py-5">
      <div class="container py-5">
         <div class="section-title wow fadeInUp mx-auto text-center" data-wow-delay="0.1s" style="max-width: 500px;">
